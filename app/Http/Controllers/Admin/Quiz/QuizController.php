...
class QuizController extends BaseController
{
    ...
    {
        return DB::table('quiz_quiz as q')
            ->select('q.id', 'q.title', 'q.slug','q.updated_at');
    }
    ...
    {
        $data = $request->all();
        $data['slug'] = BaseController::slugify($data['title'].'-'.rand(1111,9999));
